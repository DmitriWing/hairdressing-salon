...
<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
  <h6 class="m-0 font-weight-bold text-primary">Управление услугами - Добавить</h6>
...
<div class="card-body">
  <form action="{{url('addcategory')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input name="cost_lower" type="number" class="form-control" id="lowerPrice" step="0.01">
      <div class="valid-feedback"></div>
    </div>
    
    <div class="form-group">
      <label for="upperPrice">Цена до:</label>
      <input name="cost_upper" type="number" class="form-control" id="upperPrice" step="0.01">
      <div class="valid-feedback"></div>
    </div>
    ...
    <div class="form-group">
      ...
      <select name="color" class="form-control" id="color">
        ...
        <option value={{$color}} class="text-{{$color}}">{{ucfirst($color)}}</option>
        @endforeach
